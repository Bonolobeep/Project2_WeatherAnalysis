...
2017 U.S. Daily Weather Analysis
What is this?
This is my exploratory data analysis (EDA) project where I investigated over 416,000 weather records from NOAA. I wanted to see if I could find clear seasonal patterns in the numbers and check if the data was actually accurate. I produced 13 different visualizations to uncover the story behind the weather in 2017.
...
Install the tools: pip install pandas seaborn matplotlib
...
Quick Lessons from the Data
The "Mountain" Shape: By converting raw strings into month numbers, I found a perfect seasonal wave that peaks in July.
...
weather.csv.gz: The raw dataset used for the analysis.
weather_analysis.ipynb: The Python code/notebook containing the EDA.
Weather_Report_Visuals.docx: A document containing all 13 visualizations and detailed captions.
README.md: This project summary.

Credits
Data provided by NOAA. Big thanks to my lecturer Miss Ishe for the guidance on how to explore and visualize complex datasets!
